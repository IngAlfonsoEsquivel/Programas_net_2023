...
Console.Write("Nombre del estudiante: ");
        ...
        // Mostrar resultado
        if (aceptado) {
            Console.WriteLine("El estudiante {0} ha sido aceptado en la Universidad Monster Univerity.", nombre);
        } else {
            Console.WriteLine("Lo siento, el estudiante {0} no cumple con los requisitos para ser aceptado en la Universidad  Monster Univerity.", nombre);
        }